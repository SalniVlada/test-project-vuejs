...
export default {
  ...
  methods: {
    ...
    async fetchBlog() {
      try {
        const blogRecId = this.$route.params.id;
        const url = `https://6082e3545dbd2c001757abf5.mockapi.io/qtim-test-work/posts/${blogRecId}`;
        const response = await axios.get(url);
        const results = response.data;
        this.createdAt = results.createdAt;
        this.title = results.title;
        this.preview = results.preview;
...
window.replaceImageByDefault = function (img) {
  img.setAttribute("src", "http://via.placeholder.com/640x480");
};
</script>
              ...
              <article class="blog-post-wrapper">
                <div class="post-thumbnail">
                  <img
                    :src="this.image"
                    alt=""
                    onerror="replaceImageByDefault(this)"
                  />
                </div>
                <div class="post-information">
                  ...
                  <div class="entry-meta">
                    <span class="author-meta"
                      ><i class="bi bi-person"></i> <a href="#">admin</a></span
                    >
                    <span
                        ...
                        <div class="comments-details">
                          ...
                          <div class="comments-content-wrap">
                            ...
                            <p>
                              ...
                              vehicula vel mauris. Aenean at justo dolor. Fusce
                              ac sapien bibendum, scelerisque libero nec
                            </p>
                          </div>
                        </div>
                      </li>
